...
const Welcome: React.FC = () => {
  ...
  // Cerrar modal de cotización al presionar Escape
  useEffect(() => {
    ...
    if (isCotizationModalOpen || isVideoModalOpen) {
  ...
  }, [isCotizationModalOpen, isVideoModalOpen]);
  ...
  return (
    <>
      ...
      {isCotizationModalOpen && (
        <div
          className={styles.cotizationModalOverlay}
          onClick={closeCotizationModal}
        >
          <div
            className={styles.cotizationModalContent}
            onClick={(e) => e.stopPropagation()}
          >
            <button 
              className={styles.cotizationModalCloseButton}
              onClick={closeCotizationModal}
            >
              X
            </button>
